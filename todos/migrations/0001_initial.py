# Generated by Django 4.1.4 on 2023-02-10 22:14
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='Month',
            fields=[
                ('monthdate', models.TextField(default=todos.models.monthdate, primary_key=True, serialize=False)),
            ],
            options={
                'ordering': ['-monthdate'],
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('month', models.ForeignKey(default=todos.models.thismonth, on_delete=django.db.models.deletion.PROTECT, related_name='days', to='todos.month')),
            ],
            options={
                'ordering': ['-daydate'],
            },
